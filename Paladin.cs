...
namespace DragonRescue
{
    public class Paladin : Sprite
    {
        ...
        #region Constructor
        public Paladin(Vector2 position, Texture2D texture1, Texture2D texture2, Texture2D texture3, Texture2D texture4, Rectangle Frame, int frameCount, Rectangle collision1, Rectangle collision2, int hp)
